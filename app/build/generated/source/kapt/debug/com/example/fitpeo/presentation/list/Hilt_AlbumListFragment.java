 ...
 */
public abstract class Hilt_AlbumListFragment<vModel extends BaseViewModel, viewDataBinding extends ViewDataBinding> extends BaseFragment<vModel, viewDataBinding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlbumListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlbumListFragment_GeneratedInjector) this.generatedComponent()).injectAlbumListFragment(UnsafeCasts.<AlbumListFragment>unsafeCast(this));
    }
  }
