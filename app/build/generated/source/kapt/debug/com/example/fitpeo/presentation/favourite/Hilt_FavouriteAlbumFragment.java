 ...
 */
public abstract class Hilt_FavouriteAlbumFragment<vModel extends BaseViewModel, viewDataBinding extends ViewDataBinding> extends BaseFragment<vModel, viewDataBinding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavouriteAlbumFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavouriteAlbumFragment_GeneratedInjector) this.generatedComponent()).injectFavouriteAlbumFragment(UnsafeCasts.<FavouriteAlbumFragment>unsafeCast(this));
    }
  }
