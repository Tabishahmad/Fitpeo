 ...
 */
public abstract class Hilt_AlbumDetailFragment<vModel extends BaseViewModel, viewDataBinding extends ViewDataBinding> extends BaseFragment<vModel, viewDataBinding> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlbumDetailFragment(int layoutId) {
    super(layoutId);
  }
